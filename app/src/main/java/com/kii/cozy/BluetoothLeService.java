...
public class BluetoothLeService extends Service {
    ...
    public final static UUID UUID_COZY_CONFIG_SERVICE =
            UUID.fromString(SampleGattAttributes.COZY_CONFIG_SERVICE_UUID);
    ...
    private void broadcastUpdate(final String action,
        ...
        if (UUID_COZY_CONFIG_SERVICE.equals(characteristic.getUuid())) {
